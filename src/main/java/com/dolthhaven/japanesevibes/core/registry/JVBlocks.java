...
public class JVBlocks {
    ...
    public static final RegistryObject<Block> PAPER_LANTERN_BLACK_DOT = HELPER.createBlock("paper_lantern_black_dot", () -> new DirectionalLanternBlock(Properties.getLanternPropsOfColor(MaterialColor.COLOR_RED)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> PAPER_LANTERN_OBAKE = HELPER.createBlock("paper_lantern_obake", () -> new DirectionalLanternBlock(Properties.getLanternPropsOfColor(MaterialColor.COLOR_ORANGE)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> PAPER_LANTERN_RED_DOT = HELPER.createBlock("paper_lantern_red_dot", () -> new DirectionalLanternBlock(Properties.getLanternPropsOfColor(MaterialColor.COLOR_BLACK)), CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final RegistryObject<Block> PAPER_LANTERN_SUN = HELPER.createBlock("paper_lantern_sun", () -> new DirectionalLanternBlock(Properties.getLanternPropsOfColor(MaterialColor.SNOW)), CreativeModeTab.TAB_BUILDING_BLOCKS);
